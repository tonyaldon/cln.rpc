...
{:deps
 {io.github.tonyaldon/clnrpc-clj
  {:git/url "git@github.com:tonyaldon/clnrpc-clj.git"
   :git/sha "b8c4057ae07c184a6d2fb03674abed2d7ef9937c"}}}
#+END_SRC
...
For instance, we can do a ~getinfo~ request to ~lightningd~ in two ways:
...
Note that not all the builtin ~lightningd~ method are defined.  Indeed,
