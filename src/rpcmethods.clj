;; CLN v24.02 - RPC methods generated from doc/schemas directory
;;
...
(def rpcmethods
  ["addgossip" "addpsbtoutput" "autoclean-once" "autoclean-status"
   "autocleaninvoice" "batching" "bkpr-listincome" "blacklistrune"
   "checkmessage" "checkrune" "close" "commando-blacklist" "commando-listrunes"
   "commando-rune" "commando" "connect" "createinvoice" "createonion"
   "createrune" "datastore" "datastoreusage" "decode" "decodepay" "deldatastore"
   "delexpiredinvoice" "delforward" "delinvoice" "delpay"
   "disableinvoicerequest" "disconnect" "emergencyrecover" "feerates"
   "fetchinvoice" "fundchannel" "fundchannel_cancel" "fundchannel_complete"
   "fundchannel_start" "fundpsbt" "getinfo" "getroute" "invoice"
   "invoicerequest" "keysend" "listchannels" "listclosedchannels"
   "listdatastore" "listforwards" "listfunds" "listhtlcs" "listinvoicerequests"
   "listinvoices" "listnodes" "listoffers" "listpays" "listpeerchannels"
   "listpeers" "listsendpays" "listsqlschemas" "listtransactions" "makesecret"
   "multifundchannel" "newaddr" "offer" "openchannel_init" "pay" "ping"
   "preapproveinvoice" "preapprovekeysend" "recoverchannel" "sendcustommsg"
   "sendonion" "sendpay" "sendpsbt" "setchannel" "setconfig" "showrunes"
   "signinvoice" "signmessage" "signpsbt" "splice_init" "splice_signed"
   "splice_update" "sql" "staticbackup" "stop" "txdiscard" "txprepare" "txsend"
   "upgradewallet" "utxopsbt" "wait" "waitanyinvoice" "waitblockheight"
   "waitinvoice" "waitsendpay" "withdraw"])
